...
final List<EngineExercise> defaultExercises = [
  ...
  EngineExercise(
    ...
    name: 'Barbell Row',
    muscleMap: [
      MuscleActivation(muscleId: 'back', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'biceps', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.barbell,
    movement: MovementClass.compoundUpper,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'back', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'biceps', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.synergist, coefficient: 0.3),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.15),
    ],
    equipment: EquipmentClass.cable,
    movement: MovementClass.compoundUpper,
  ...
  EngineExercise(
    ...
    muscleMap: [
      ...
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.synergist, coefficient: 0.25),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.bodyweight,
    movement: MovementClass.compoundUpper,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'back', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.6),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'quad', role: MuscleRole.synergist, coefficient: 0.4),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'back', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.25),
      MuscleActivation(muscleId: 'forearms', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.barbell,
  ...
  EngineExercise(
    ...
    name: 'Overhead Press',
    muscleMap: [
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.primary, coefficient: 1.0),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'anterior_deltoid', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.synergist, coefficient: 0.4),
  ...
  EngineExercise(
    ...
    name: 'Face Pull',
    muscleMap: [
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.primary, coefficient: 1.0),
      ...
      MuscleActivation(muscleId: 'back', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.cable,
    movement: MovementClass.isolation,
  ),
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'upper_trapezius', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'back', role: MuscleRole.synergist, coefficient: 0.3),
    ],
    equipment: EquipmentClass.dumbbell,
    movement: MovementClass.isolation,
  ),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'quad', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.6),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.25),
      MuscleActivation(muscleId: 'calf', role: MuscleRole.stabilizer, coefficient: 0.15),
    ],
    equipment: EquipmentClass.barbell,
    movement: MovementClass.compoundLower,
  ),
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'quad', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.35),
  ...
  EngineExercise(
    ...
    muscleMap: [
      ...
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.35),
      MuscleActivation(muscleId: 'calf', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.machine,
    movement: MovementClass.compoundLower,
  ),
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'quad', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.3),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.25),
    ],
    equipment: EquipmentClass.dumbbell,
    movement: MovementClass.compoundLower,
  ...
  EngineExercise(
    ...
    name: 'Leg Curl',
    muscleMap: [
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'calf', role: MuscleRole.synergist, coefficient: 0.3),
    ],
    equipment: EquipmentClass.machine,
    movement: MovementClass.isolation,
  ),
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.6),
      MuscleActivation(muscleId: 'back', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.barbell,
    movement: MovementClass.compoundLower,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'calf', role: MuscleRole.primary, coefficient: 1.0),
    ],
    equipment: EquipmentClass.machine,
    movement: MovementClass.isolation,
  ),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'triceps', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.dumbbell,
    movement: MovementClass.isolation,
  ),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'core', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'back', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.stabilizer, coefficient: 0.25),
    ],
    equipment: EquipmentClass.bodyweight,
    movement: MovementClass.isolation,
  ),
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'core', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.stabilizer, coefficient: 0.25),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.bodyweight,
    movement: MovementClass.isolation,
  ),
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'glute', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'quad', role: MuscleRole.synergist, coefficient: 0.3),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.2),
    ],
    equipment: EquipmentClass.barbell,
    movement: MovementClass.compoundLower,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'glute', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'quad', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'back', role: MuscleRole.synergist, coefficient: 0.4),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.25),
    ],
    equipment: EquipmentClass.barbell,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.3),
      MuscleActivation(muscleId: 'core', role: MuscleRole.stabilizer, coefficient: 0.15),
    ],
    equipment: EquipmentClass.bodyweight,
    movement: MovementClass.isolation,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'core', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'shoulder', role: MuscleRole.synergist, coefficient: 0.35),
      MuscleActivation(muscleId: 'hip_flexors', role: MuscleRole.synergist, coefficient: 0.3),
    ],
    equipment: EquipmentClass.cable,
    movement: MovementClass.isolation,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'back', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'rear_delt', role: MuscleRole.synergist, coefficient: 0.5),
      MuscleActivation(muscleId: 'biceps', role: MuscleRole.synergist, coefficient: 0.4),
    ],
    equipment: EquipmentClass.dumbbell,
    movement: MovementClass.compoundUpper,
  ...
  EngineExercise(
    ...
    muscleMap: [
      MuscleActivation(muscleId: 'quad', role: MuscleRole.primary, coefficient: 1.0),
      MuscleActivation(muscleId: 'glute', role: MuscleRole.synergist, coefficient: 0.7),
      MuscleActivation(muscleId: 'hamstring', role: MuscleRole.synergist, coefficient: 0.4),
    ],
    equipment: EquipmentClass.dumbbell,
    movement: MovementClass.compoundLower,
