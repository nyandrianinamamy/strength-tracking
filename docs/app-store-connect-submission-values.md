...
- Promotional text: `Plan routines, log workouts, and track progress with a scientific training engine and Apple Watch support.`
- Keywords: `strength,workout,gym,fitness,training,tracker,weights,routines,progress`
- Support URL: `https://kotrana.mamy-r.dev/support`
- Marketing URL: leave blank if App Store Connect allows it
- Privacy Policy URL: `https://kotrana.mamy-r.dev/privacy`
- Copyright: `© 2026 Mamy Razafintsialonina`
...
- Username/email: `app-review@mamy-r.dev`
- Password: paste the real reviewer password from the private conversation/context
...
- Messaging/chat: no
- Advertising: no
- Gambling, contests, loot boxes, simulated gambling: no
- Violence, sexual content, drugs, alcohol, horror, profanity, crude humor: no
...
- Health & Fitness: workouts, routines, progress, readiness/training data, optional Apple Health-derived sleep, HRV, and resting heart rate
- User Content: optional exercise/machine photos
...
- Crash or diagnostic data beyond Apple's normal platform reporting
- Advertising data
- Tracking data

## Accessibility Labels

Do not claim accessibility labels until verified against the actual release build. Candidates to verify manually before selecting:
...
Leave unclaimed unless directly verified:
...
- Select build: `1.0.31 (275)` after the `v1.0.31` tag upload has completed processing.
