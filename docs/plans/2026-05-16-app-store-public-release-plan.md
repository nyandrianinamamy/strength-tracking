...
- This release-prep branch bumps `pubspec.yaml` to `1.0.31+277`; tag `v1.0.31` should upload App Store Connect build `1.0.31 (277)`.
...
7. Confirm App Store Connect receives build `1.0.31 (277)`.
